'''
For single gpu:
python ego4d_face_tracking.py --input_folder ./nora_data --save_folder path/to/save/csv_file(suggest storing in './nora_data', together with input video)

Multi gpu:
accelerate config
accelerate launch ego4d_face_tracking.py --input_folder ./nora_video/video --save_folder path/to/save/csv_file

Accelerate can refer to https://huggingface.co/docs/accelerate/basic_tutorials/launch
'''
